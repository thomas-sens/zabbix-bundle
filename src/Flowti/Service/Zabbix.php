...
class Zabbix
{
    private $zabbix_rest_endpoint_user, $zabbix_rest_endpoint_pass, $zabbix_rest_endpoint, $funcoes, $zbClient, $token_auth;

	public function __construct(ParameterBagInterface $params)
    {				
        $this->zabbix_rest_endpoint_user = $params->get('zabbix_rest_endpoint_user');
        $this->zabbix_rest_endpoint_pass = $params->get('zabbix_rest_endpoint_pass');
        $this->zabbix_rest_endpoint = $params->get('zabbix_rest_endpoint');
